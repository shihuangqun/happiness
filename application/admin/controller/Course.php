...
class Course extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $this->view->assign("updatestatusList", $this->model->getUpdatestatusList());
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            foreach ($list as $row) {
                $row->visible(['id','type','teacher_id','image','title','category_id','price','studynum','updatestatus','weight','status']);
