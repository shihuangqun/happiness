...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIxuygH1A8aBBX"; // AccessKeyId

        $accessKeySecret = "G2cf4YhaNLb36pt34u8jhKOoclf2nK"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($code,$phone,$template) {
...
//
//$response = SmsDemo::sendSms('159159',15207251055,'SMS_162524239');
