!function(e) {
    ...
    i.dialog = function(e, i, t, a) {
        ...
        i.image = function(t, a, n) {
            require(["webuploader", "cropper", "previewer"], function(o) {
                var s, r, d, c = i.querystring("i"), l = i.querystring("j");
                defaultOptions = {
                    pick: {
                        id: "#filePicker",
                        label: "点击选择图片",
                ...
                "android" == i.agent() && (defaultOptions.sendAsBinary = !0),
                    n = $.extend({}, defaultOptions, n),
                t && (t = $(t),
                    n.pick = {
                        id: t,
                        multiple: n.pick.multiple
                    }),
                n.multiple && (n.pick.multiple = n.multiple,
                    n.fileNumLimit = 8),
                n.crop && (n.auto = !1,
                    n.pick.multiple = !1,
                    n.preview = !1,
                ...
                n.preview && (d = mui.previewImage({
                    ...
                    r.on("fileQueued", function(e) {
                        i.loading().show(),
                        n.crop && r.makeThumb(e, function(i, t) {
                            r.file = e,
                            i || s.preview(t)
                        }, 1, 1)
                    }),
                    ...
                    r.onError = function(e) {
                        s.reset(),
                            i.loading().close(),
                            "Q_EXCEED_SIZE_LIMIT" != e ? "Q_EXCEED_NUM_LIMIT" != e ? alert("错误信息: " + e) : i.toast("单次最多上传8张") : alert("错误信息: 图片大于 4M 无法上传.")
                    }
                    ,
                    s = function() {
                        var t, a;
                        return {
                            preview: function(o) {
                                return (t = $(e.util.templates["avatar.preview.html"])).css("height", $(e).height()),
            ...
            require(["map"], function(a) {
                ...
                if (0 == r.length) {
                    (r = i.dialog("请选择地点", '<div class="form-group"><div class="input-group"><input type="text" class="form-control" placeholder="请输入地址来直接查找相关位置"><div class="input-group-btn"><button class="btn btn-default"><i class="icon-search"></i> 搜索</button></div></div></div><div id="map-container" style="height:400px;"></div>', '<button type="button" class="btn btn-default" data-dismiss="modal">取消</button><button type="button" class="btn btn-primary">确认</button>', {
                        ...
                        map = i.map.instance = new a.Map("map-container"),
                        ...
                        marker = i.map.marker = new a.Marker(o),
        ...
        i.pay = function(t) {
            ...
            if ((t = $.extend({}, a, t)).orderFee && !(t.orderFee <= 0)) {
                ...
                var n = mui.className("active")
                    ...
                    , r = function(e) {
                    e ? ($(".mui-content")[0].setAttribute("style", "overflow:hidden;"),
                        document.body.setAttribute("style", "overflow:hidden;")) : ($(".mui-content")[0].setAttribute("style", ""),
                    ...
                    , c = function(e) {
                    "main" == e ? (s.find(".js-main-modal").show().addClass("fadeInRight animated"),
                        s.find(".js-switch-pay-modal").hide(),
                        s.find(".js-switch-modal").hide()) : "pay" == e && (s.find(".js-main-modal").hide(),
                        s.find(".js-switch-pay-modal").show().addClass("fadeInRight animated"),
                        s.find(".js-switch-modal").show())
                };
                return i.loading().show(),
                    t.enableMethod && t.enableMethod.length > 1 ? $.post("index.php?i=" + e.sysinfo.uniacid + "&j=" + e.sysinfo.acid + "&c=entry&m=core&do=paymethod", {
                        module: t.module,
                        tid: t.orderTid,
                        title: t.orderTitle,
                        fee: t.orderFee
                        ...
                        if (i.loading().hide(),
                            ...
                            r(!0),
                            s.find(".js-switch-modal").click(function() {
                                c("main")
                            }),
                            ...
                            s.find(".js-order-title").html(t.orderTitle),
                            s.find(".js-pay-fee").html(t.orderFee),
                            !(s.find(".js-switch-pay-modal li").size() > 0))
                            return i.toast("暂无有效支付方式"),
                                s.remove(),
                                $(d).remove(),
                                document.body.setAttribute("style", ""),
                                !1;
                        ...
                        var a = 0;
                        "miniprogram" === e.__wxjs_environment && (a = 1),
                            $.post("index.php?i=" + e.sysinfo.uniacid + "&j=" + e.sysinfo.acid + "&c=entry&m=core&do=pay&iswxapp=" + a, {
                                method: t.payMethod,
                                tid: t.orderTid,
                                title: t.orderTitle,
                                fee: t.orderFee,
                                ...
                                if (i.loading().hide(),
                                    (e = $.parseJSON(e)).message.errno) {
                                    if ("2" == e.message.errno)
                                        return void i.message("确认您的支付身份，跳转支付中", e.message.message, "success");
                                    var a = {
                    ...
                    }() : "alipay" == t.payMethod ? (i.loading().hide(),
                        $.post("index.php?i=" + e.sysinfo.uniacid + "&j=" + e.sysinfo.acid + "&c=entry&m=core&do=pay", {
                            method: t.payMethod,
                            tid: t.orderTid,
                            title: t.orderTitle,
                            fee: t.orderFee,
        ...
        i.poppicker = function(e, i) {
            require(["mui.datepicker"], function() {
                mui.ready(function() {
                    ...
                    t.setData(e.data),
                    $.isFunction(e.setSelectedValue) && e.setSelectedValue(t.pickers),
                        t.show(function(e) {
                            $.isFunction(i) && i(e),
                                t.dispose()
                        })
        ...
        i.tomedia = function(i, t) {
            ...
            if (0 == i.indexOf("./addons"))
                return e.sysinfo.siteroot + i.replace("./", "");
            -1 != i.indexOf(e.sysinfo.siteroot) && -1 == i.indexOf("/addons/") && (i = i.substr(i.indexOf("images/"))),
        ...
        i.sendCode = function(i, t) {
            ...
            t.showElement.html(t.showTips.replace("%s", o)),
                t.showElement.attr("disabled", !0);
            var s = setInterval(function() {
                --o <= 0 ? (clearInterval(s),
                    o = 60,
                    t.showElement.html(t.btnTips),
                    t.showElement.attr("disabled", !1)) : t.showElement.html(t.showTips.replace("%s", o))
            }, 1e3)
                , r = {};
            r.receiver = i,
                r.uniacid = e.sysinfo.uniacid,
        ...
        i.card = function() {
            $.post("./index.php?c=utility&a=card", {
                ...
                0 == (t = $.parseJSON(t)).message.errno)
                    return i.message("没有开通会员卡功能", "", "info"),
                        !1;
                ...
                2 == t.message.errno && (location.href = "./index.php?i=" + e.sysinfo.uniacid + "&c=mc&a=card&do=mycard"),
    ...
    function(e, i) {
        e["avatar.preview.html"] = '<div class="fadeInDownBig animated js-avatar-preview avatar-preview" style="position:relative; width:100%;z-index:9999"><img src="" alt="" class="cropper-hidden"><div class="bar-action mui-clearfix"><a href="javascript:;" class="mui-pull-left js-cancel">取消</a> <a href="javascript:;" class="mui-pull-right mui-text-right js-submit">选取</a></div></div>',
            e["image.preview.html"] = '<div class="bar-action mui-clearfix"><a href="javascript:;" class="mui-pull-left js-cancel">取消</a> <a href="javascript:;" class="mui-pull-right mui-text-right js-submit">删除</a></div>',
            e["message.html"] = '<div class="mui-content-padded"><div class="mui-message"><div class="mui-message-icon"><span></span></div><h4 class="title"></h4><p class="mui-desc"></p><div class="mui-button-area"><a href="javascript:;" class="mui-btn mui-btn-success mui-btn-block">确定</a></div></div></div>'
