...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('会员等级'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-memberservice_id" data-field="title" data-source="member_service/index" class="form-control selectpage" name="row[memberservice_id]" type="text" value="<?php echo htmlentities($row['memberservice_id']); ?>" placeholder="普通用户">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('用户名'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
