<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/c.yaoget.cn/public/../application/admin/view/chapter/add.html";i:1565854289;s:67:"/www/wwwroot/c.yaoget.cn/application/admin/view/layout/default.html";i:1562338656;s:64:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/meta.html";i:1562338656;s:66:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-chapter_type" data-rule="required" class="form-control selectpicker" name="row[chapter_type]">
                <?php if(is_array($chapterTypeList) || $chapterTypeList instanceof \think\Collection || $chapterTypeList instanceof \think\Paginator): if( count($chapterTypeList)==0 ) : echo "" ;else: foreach($chapterTypeList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"1"))): ?>selected<?php endif; ?> id="aa"><?php echo $vo; ?></option>
   ...
   <div id="video">
       ...
       <div class="form-group">
           ...
           <div class="col-xs-12 col-sm-8">
               <div class="input-group">
                   <input id="c-audio_file" class="form-control" size="50" name="row[audio_file]" type="text">
                   <div class="input-group-addon no-border no-padding">
