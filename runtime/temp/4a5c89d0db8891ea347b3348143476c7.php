<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"/www/wwwroot/c.yaoget.cn/public/../application/index/view/finance/list.html";i:1568424962;s:64:"/www/wwwroot/c.yaoget.cn/application/index/view/common/meta.html";i:1568100133;s:63:"/www/wwwroot/c.yaoget.cn/application/index/view/common/nav.html";i:1568191990;s:66:"/www/wwwroot/c.yaoget.cn/application/index/view/common/footer.html";i:1567132625;}*/ ?>
<!--<meta charset="utf-8">-->
    ...
    <div style="width:100%;height: 90px;background: white;margin-bottom: 10px;">
        <div style="padding: 5px 5% 5px 5%">
            <div style="position: relative">
                <div style="float: left;font-size: 12px;color: #666;">
                    <span>订单号：<?php echo $vo['order_no']; ?></span>
                </div>
<!--                <div style="float: right;font-size: 12px;color: #666;">申请时间:<?php echo date("Y-m-d H:i:s",$vo['createtime']); ?></div>-->
            </div>
            <br>
            <div style="position: relative;margin-top:10px;">
                ...
                <div style="float: left;line-height: 1.6;margin-top: 5px;margin-left: 5px;">
                    <div>
                        <span><?php echo $vo['nickname']; ?>&nbsp;(<?php echo $vo['name']; ?>)</span><br>
                        <span><?php echo $vo['phone']; ?></span>
                    </div>
                </div>
                <div style="float: right;line-height: 1.5;margin-top: 10px;">
                    <span>提现金额：</span><span style="width:100px;height: 30px;color:#e2892a"> <?php echo $vo['money']; ?></span><span style="color:#666">（<?php if($vo['status'] == 0): ?>待审核<?php else: ?>已审核<?php endif; ?>）</span><br>
                    <span style="width:100px;font-size: 12px;color: #666;"><?php if($vo['status'] == 1): ?>到账时间:<?php echo date("Y-m-d H:i:s",$vo['createtime']); else: ?>申请时间:<?php echo date("Y-m-d H:i:s",$vo['createtime']); endif; ?></span>
                </div>
            </div>
        </div>
    </div>
