<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/c.yaoget.cn/public/../application/admin/view/order_vip/add.html";i:1568207987;s:67:"/www/wwwroot/c.yaoget.cn/application/admin/view/layout/default.html";i:1562338656;s:64:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/meta.html";i:1566096906;s:66:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/script.html";i:1566096255;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <!--    <div class="col-xs-12 col-sm-8">-->
    <!--        <input id="c-paymenttime" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[paymenttime]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">-->
    <!--    </div>-->
    <!--</div>-->
