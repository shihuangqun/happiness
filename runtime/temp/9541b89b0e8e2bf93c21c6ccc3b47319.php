<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/www/wwwroot/c.yaoget.cn/public/../application/admin/view/order_vip/edit.html";i:1565851479;s:67:"/www/wwwroot/c.yaoget.cn/application/admin/view/layout/default.html";i:1562338656;s:64:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/meta.html";i:1562338656;s:66:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Memberservice_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-memberservice_id" data-rule="required" data-field="title" data-source="member_service/index" class="form-control selectpage" name="row[memberservice_id]" type="text" value="<?php echo htmlentities($row['memberservice_id']); ?>">
        </div>
    </div>
    <div class="form-group">
