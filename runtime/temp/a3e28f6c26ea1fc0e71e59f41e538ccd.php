...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-memberservice_id"  data-field="title" data-source="member_service/index" class="form-control selectpage" name="row[memberservice_id]" type="text" value="" placeholder="普通用户">
        </div>
    </div>
    <div class="form-group">
