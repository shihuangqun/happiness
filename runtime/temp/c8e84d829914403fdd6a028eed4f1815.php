<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/c.yaoget.cn/public/../application/admin/view/partner/add.html";i:1568257712;s:67:"/www/wwwroot/c.yaoget.cn/application/admin/view/layout/default.html";i:1562338656;s:64:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/meta.html";i:1566096906;s:66:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/script.html";i:1566096255;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group" style="" id="quota">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-quota" data-rule="required" class="form-control" step="0.01" name="row[quota]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-pid" data-source="userinfo/index" data-field="nickname" class="form-control selectpage" name="row[pid]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[order_status]-<?php echo $key; ?>"><input id="row[order_status]-<?php echo $key; ?>" name="row[order_status]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"1"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
    ...
    <div class="form-group" style="display:none">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-crearetime" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[crearetime]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
