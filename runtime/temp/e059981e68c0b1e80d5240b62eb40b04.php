<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/www/wwwroot/c.yaoget.cn/public/../application/admin/view/order/edit.html";i:1568426026;s:67:"/www/wwwroot/c.yaoget.cn/application/admin/view/layout/default.html";i:1562338656;s:64:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/meta.html";i:1566096906;s:66:"/www/wwwroot/c.yaoget.cn/application/admin/view/common/script.html";i:1566096255;}*/ ?>
<!DOCTYPE html>
...
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-user_id" data-rule="required" data-source="userinfo/selectpage_new" data-field="nickname" class="form-control selectpage" name="row[user_id]" type="text" value="<?php echo htmlentities($row['user_id']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
...
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-commission" class="form-control" name="row[commission]" type="text" value="<?php echo htmlentities($row['commission']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Recommend'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-recommend" class="form-control" name="row[recommend]" type="text" value="<?php echo htmlentities($row['recommend']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Commission_two'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-commission_two" class="form-control" name="row[commission_two]" type="text" value="<?php echo htmlentities($row['commission_two']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Recommend_two'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-recommend_two" class="form-control" name="row[recommend_two]" type="text" value="<?php echo htmlentities($row['recommend_two']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Commission_three'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-commission_three" class="form-control" name="row[commission_three]" type="text" value="<?php echo htmlentities($row['commission_three']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Recommend_three'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-recommend_three" class="form-control" name="row[recommend_three]" type="text" value="<?php echo htmlentities($row['recommend_three']); ?>">-->
<!--        </div>-->
<!--    </div>-->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <div class="radio">
                <label for="row[is_royalty]-1"><input id="row[is_royalty]-1" name="row[is_royalty]" type="radio" value="1" <?php if($row['is_royalty'] == 1): ?>checked <?php endif; ?>/> 是</label>
                <label for="row[is_royalty]-0"><input id="row[is_royalty]-0" name="row[is_royalty]" type="radio" value="0" <?php if($row['is_royalty'] == 0): ?>checked <?php endif; ?>/> 否</label>
            </div>
        </div>
    </div>
    <div class="form-group">
...
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-paymenttime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[paymenttime]" type="text" value="<?php echo $row['paymenttime']?datetime($row['paymenttime']):''; ?>">-->
<!--        </div>-->
<!--    </div>-->
